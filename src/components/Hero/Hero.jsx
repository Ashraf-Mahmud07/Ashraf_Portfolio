...
import hero from "../../assets/images/ashraf_image.png"
      ...
      <div className="flex-1">
        <div className="md:text-left text-center">
          <h1 className="md:text-5xl text-2xl md:leading-normal leading-10 text-white font-bold">
            ...
            My Name is <span>Ashraful Islam Ashraf</span>
          </h1>
          ...
          <div className="mt-8 text-3xl flex items-center md:justify-start justify-center gap-5">
            ...
            <a href="" target='_blank'><FaTwitter className="text-gray-600 hover:text-white cursor-pointer" /></a>
            <a href="https://www.instagram.com/_ashraf_mahmud_/" target='_blank'><FaInstagram className="text-gray-600 hover:text-white cursor-pointer" /></a>  
            <a
              href="https://www.facebook.com/ashraf.mahmud.444/"
              target="_blank"
              rel="noreferrer"
            >
