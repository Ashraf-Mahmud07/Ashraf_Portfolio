...
import project1 from "../../assets/images/portfolio1 (2).png";
import project2 from "../../assets/images/portfolio2.png";
import project3 from "../../assets/images/portfolio3.png";
import project4 from "../../assets/images/portfolio4.png";
import "./Project.css";
...
const Projects = () => {
  ...
  const projects = [
    {
      img: project1,
      name: "Teaching Corner - Language Learning School(MERN Stack)",
      github_client: "https://teaching-corner-f9e19.web.app/",
      github_server: "https://teaching-corner-f9e19.web.app/",
      live_link: "https://teaching-corner-f9e19.web.app/",
      featues: [
    ...
    {
      img: project2,
      name: "Kid's Zone - Kid's Toy Marketplace(MERN Stack)",
      github_client: "https://kids-zone-4629a.web.app/",
      github_server: "https://kids-zone-4629a.web.app/",
      live_link: "https://kids-zone-4629a.web.app/",
      featues: [
    ...
    {
      img: project3,
      name: "Special Cheif Hunter - Recipe and Chef(Front-end)",
      github_client: "https://special-chef-hunter.web.app/",
      github_server: "https://special-chef-hunter.web.app/",
      live_link: "https://special-chef-hunter.web.app/",
      featues: [
    ...
    {
      img: project4,
      name: "Shoppable - E-Commerce site for Shopping(Front-end)",
      github_client: "https://github.com/Ashraf-Mahmud07/plx-test",
      github_server: "https://special-chef-hunter.web.app/",
      live_link: "https://plx-test.netlify.app/",
      featues: [
        "On this site, I use Firebase authentication and use the private route for authenticating users.",
        "On this site, I implement Dark mood, and use Tailwind CSS & DaisyUI for style web pages.",
        "I used some react awesome components for interactive web pages, react icons, sweetalert2.",
